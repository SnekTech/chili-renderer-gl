...
#ifndef CHILI_RENDERER_GL_VERTEXPOSITIONCOLOREFFECT_H
#define CHILI_RENDERER_GL_VERTEXPOSITIONCOLOREFFECT_H
...
#endif //CHILI_RENDERER_GL_VERTEXPOSITIONCOLOREFFECT_H
