...
#ifndef CHILI_RENDERER_GL_CUBESKINNED_H
#define CHILI_RENDERER_GL_CUBESKINNED_H
...
public:
    ...
    [[nodiscard]] IndexedTriangleList<TexVertex> GetTrianglesTex() const
    {
...
#endif //CHILI_RENDERER_GL_CUBESKINNED_H
