...
#ifndef CHILI_RENDERER_GL_CUBEVERTEXPOSITIONCOLORSCENE_H
#define CHILI_RENDERER_GL_CUBEVERTEXPOSITIONCOLORSCENE_H
...
public:
    explicit CubeVertexPositionColorScene(Graphics& gfx)
...
#endif //CHILI_RENDERER_GL_CUBEVERTEXPOSITIONCOLORSCENE_H
