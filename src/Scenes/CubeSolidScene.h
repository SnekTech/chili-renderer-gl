...
#ifndef CHILI_RENDERER_GL_CUBESOLIDSCENE_H
#define CHILI_RENDERER_GL_CUBESOLIDSCENE_H
...
public:
    explicit CubeSolidScene(Graphics& gfx)
...
#endif //CHILI_RENDERER_GL_CUBESOLIDSCENE_H
